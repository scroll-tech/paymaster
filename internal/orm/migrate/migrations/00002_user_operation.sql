...
CREATE UNIQUE INDEX unique_sender_nonce ON user_operation(sender, nonce) WHERE deleted_at IS NULL;
CREATE INDEX idx_api_key_sender_updated_at ON user_operation(api_key, sender, updated_at) WHERE deleted_at IS NULL;
